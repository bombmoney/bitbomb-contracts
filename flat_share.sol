...
*/
contract BitShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 110,000 Share
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 43800 ether;

    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 5000 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 4800 ether;
    ...
    constructor(
        ...
        address _devFund
    ) public ERC20("bitBOMB SHARE Token", "bitSHARE") {
        _mint(msg.sender, 400 ether); // mint 100 Share for initial pools deployment

...
export interface EpochStatsInterface extends utils.Interface {
  functions: {
    ...
    "totalMarketingFunding()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "totalMarketingFunding",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface EpochStats extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EpochStatsInterface;
  ...
  functions: {
    ...
    totalMarketingFunding(overrides?: CallOverrides): Promise<[BigNumber]>;

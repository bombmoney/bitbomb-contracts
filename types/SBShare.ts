...
export interface SBShareInterface extends utils.Interface {
  functions: {
    ...
    "SPECIAL_POOL_REWARD_ALLOCATION()": FunctionFragment;
    ...
    "distributeReward(address,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "SPECIAL_POOL_REWARD_ALLOCATION",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SBShare extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SBShareInterface;
  ...
  functions: {
    ...
    SPECIAL_POOL_REWARD_ALLOCATION(
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
  ...
  SPECIAL_POOL_REWARD_ALLOCATION(overrides?: CallOverrides): Promise<BigNumber>;

...
export interface SBSFarmRewardPoolInterface extends utils.Interface {
  functions: {
...
export interface SBSFarmRewardPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SBSFarmRewardPoolInterface;

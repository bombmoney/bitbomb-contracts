...
export interface SBSSpecialRewardPoolInterface extends utils.Interface {
  functions: {
...
export interface SBSSpecialRewardPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SBSSpecialRewardPoolInterface;
